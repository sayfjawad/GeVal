...
public class IOUtils {
    ...
    /**
     * Haal een resource op door deze eerst op te zoeken in het bestandssysteem ,
     * vervolgens van een URL, of uiteindelijk in de classpath.
     *
    ...
    public static URL getResourceAsUrl(final String resourceName, final Class clazz) {
        ...
        if (url == null) {
            try {
                ...
                LOG.debug("Unable to load resource " + resourceName + " from the classpath: " + e.getMessage());
            }
        }
