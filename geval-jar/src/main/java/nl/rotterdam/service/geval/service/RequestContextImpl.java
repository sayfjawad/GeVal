...
public class RequestContextImpl implements RequestContext {
    ...
    /**
     * We onthouden de wrapper zodat we via de cache te weten komen wat de inhoud was van de
     * uitgelezen body
     */
    ...
    public RequestContextImpl(final String url, final String method,
            final Map<String, String> headers, final ContentCachingRequestWrapper request) {
    ...
    @Override
    public void setProcescode(final String procescode) {
